...
from osolar_client import ApiError, AsyncOsolarLinkClient, PlantLinkRequest
...
class RecordingAsyncRequestClient(AsyncOsolarLinkClient):
    def __init__(self) -> None:
        dummy_http_client = cast(httpx.AsyncClient, RecordingAsyncHttpClient())
        super().__init__(
            api_key="test-key",
...
) -> tuple[AsyncOsolarLinkClient, httpx.AsyncClient]:
    transport = httpx.MockTransport(handler)
    http_client = httpx.AsyncClient(transport=transport)
    client = AsyncOsolarLinkClient(
...
@pytest.mark.asyncio
async def test_search_plants_sends_expected_query_and_header() -> None:
    ...
    client, http_client = make_async_client(handler)
    try:
        response = await client.search_plants(q="foo", field="address", distance_km=2.0)
...
@pytest.mark.asyncio
async def test_search_plants_omits_none_distance_km() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
        assert request.url.path == "/v1/search"
    ...
    client, http_client = make_async_client(handler)
    try:
        response = await client.search_plants(q="foo", field="address")
        assert response["success"] is True
    finally:
        await http_client.aclose()
...
@pytest.mark.asyncio
async def test_search_plants_keeps_zero_distance_km() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
        assert request.url.path == "/v1/search"
    ...
    client, http_client = make_async_client(handler)
    try:
        response = await client.search_plants(q="foo", field="address", distance_km=0.0)
        assert response["success"] is True
    finally:
        await http_client.aclose()
...
@pytest.mark.asyncio
async def test_search_plants_rejects_unsupported_field() -> None:
    client = AsyncOsolarLinkClient(api_key="test-key")
    unsafe_client = cast(Any, client)
    try:
        with pytest.raises(
            ValueError, match=r"^`field` must be one of: business_number, address\.$"
        ):
            await unsafe_client.search_plants(q="foo", field="name")
    finally:
        await client.aclose()
...
async def test_raises_api_error_on_non_2xx() -> None:
    ...
    try:
        with pytest.raises(ApiError) as exc_info:
            await client.list_linked_plants()
...
@pytest.mark.asyncio
async def test_link_plant_supports_keyword_arguments() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
    ...
    client, http_client = make_async_client(handler)
    try:
        response = await client.link_plant(
...
@pytest.mark.asyncio
async def test_link_plant_rejects_mixed_payload_styles() -> None:
    client = AsyncOsolarLinkClient(api_key="test-key")
    unsafe_client = cast(Any, client)
    with pytest.raises(
        ValueError, match=r"^Use either `body` or keyword arguments, not both\.$"
    ):
        await unsafe_client.link_plant(
...
@pytest.mark.asyncio
async def test_link_plant_accepts_typed_dict_body() -> None:
    ...
    client, http_client = make_async_client(handler)
    try:
        response = await client.link_plant(body)
        assert response["success"] is True
    finally:
        await http_client.aclose()
...
async def test_link_plant_body_requires_plant_uuid_and_remark(body: Any) -> None:
    client = AsyncOsolarLinkClient(api_key="test-key")
    unsafe_client = cast(Any, client)
    try:
        with pytest.raises(
            ...
            await unsafe_client.link_plant(body)
    finally:
        await client.aclose()
...
async def test_link_plant_rejects_any_keyword_when_body_is_given(
    kwargs: dict[str, str],
) -> None:
    client = AsyncOsolarLinkClient(api_key="test-key")
    unsafe_client = cast(Any, client)
...
async def test_link_plant_requires_plant_uuid_and_remark_when_body_missing(
    kwargs: dict[str, str],
) -> None:
    client = AsyncOsolarLinkClient(api_key="test-key")
    unsafe_client = cast(Any, client)
    try:
        with pytest.raises(
            ...
            await unsafe_client.link_plant(**kwargs)
    finally:
        await client.aclose()


@pytest.mark.asyncio
async def test_get_plant_info_url_encodes_link_id() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
    ...
    client, http_client = make_async_client(handler)
    try:
        response = await client.get_plant_info("abc/def ghi")
        assert response["success"] is True
    finally:
        await http_client.aclose()
...
@pytest.mark.asyncio
async def test_monthly_methods_use_endpoint_specific_query_keys() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
    ...
    client, http_client = make_async_client(handler)
    try:
        generation = await client.get_monthly_generation("id", start_year=2020, end_year=2021)
        billing = await client.get_monthly_billing("id", start_year=2020, end_year=2021)
...
async def test_link_detail_methods_build_expected_paths(
...
async def test_link_detail_methods_encode_slashes_in_link_id(
...
@pytest.mark.asyncio
async def test_request_handles_empty_success_response() -> None:
    def handler(_: httpx.Request) -> httpx.Response:
...
@pytest.mark.asyncio
async def test_request_raises_api_error_on_invalid_json_success_response() -> None:
    def handler(_: httpx.Request) -> httpx.Response:
...
@pytest.mark.asyncio
async def test_request_raises_api_error_on_non_object_json_success_response() -> None:
    def handler(_: httpx.Request) -> httpx.Response:
...
@pytest.mark.asyncio
async def test_request_treats_300_as_error() -> None:
    def handler(_: httpx.Request) -> httpx.Response:
...
@pytest.mark.asyncio
async def test_request_sends_expected_header_key_exactly() -> None:
    recording_http_client = RecordingAsyncHttpClient()
    client = AsyncOsolarLinkClient(
        api_key="test-key", http_client=cast(httpx.AsyncClient, recording_http_client)
    )
    try:
        await client.list_linked_plants()
...
@pytest.mark.asyncio
async def test_init_uses_default_base_url() -> None:
    recording_http_client = RecordingAsyncHttpClient()
    client = AsyncOsolarLinkClient(
        api_key="test-key", http_client=cast(httpx.AsyncClient, recording_http_client)
    )
...
def test_init_rejects_empty_api_key() -> None:
    for api_key in ["", " ", "\t"]:
        with pytest.raises(ValueError, match=r"^`api_key` must be a non-empty string\.$"):
            AsyncOsolarLinkClient(api_key=api_key)


@pytest.mark.asyncio
async def test_init_trims_trailing_slash_from_base_url() -> None:
    recording_http_client = RecordingAsyncHttpClient()
    client = AsyncOsolarLinkClient(
        api_key="test-key",
        base_url="https://example.com/",
        http_client=cast(httpx.AsyncClient, recording_http_client),
    )
    try:
        await client.list_linked_plants()
        _, url, _ = recording_http_client.calls[0]
...
@pytest.mark.asyncio
async def test_init_does_not_strip_non_slash_suffix_from_base_url() -> None:
    recording_http_client = RecordingAsyncHttpClient()
    client = AsyncOsolarLinkClient(
        api_key="test-key",
...
@pytest.mark.asyncio
async def test_init_allows_http_base_url_for_localhost() -> None:
    recording_http_client = RecordingAsyncHttpClient()
    client = AsyncOsolarLinkClient(
        api_key="test-key",
...
@pytest.mark.asyncio
async def test_init_allows_http_base_url_for_localhost_hostname() -> None:
    recording_http_client = RecordingAsyncHttpClient()
    client = AsyncOsolarLinkClient(
        api_key="test-key",
...
@pytest.mark.asyncio
async def test_init_allows_http_base_url_for_ipv6_loopback() -> None:
    recording_http_client = RecordingAsyncHttpClient()
    client = AsyncOsolarLinkClient(
        api_key="test-key",
...
def test_init_rejects_base_url_missing_hostname() -> None:
    with pytest.raises(ValueError, match=r"^`base_url` must include a hostname\.$"):
        AsyncOsolarLinkClient(api_key="test-key", base_url="https://")


@pytest.mark.asyncio
async def test_init_uses_default_timeout_for_owned_http_client() -> None:
    client = AsyncOsolarLinkClient(api_key="test-key")
    try:
...
@pytest.mark.asyncio
async def test_list_linked_plants_passes_expected_request_signature() -> None:
    client = RecordingAsyncRequestClient()
    result = await client.list_linked_plants()
    assert result["success"] is True
    assert client.calls == [("GET", "/v1/links", None, None)]


@pytest.mark.asyncio
async def test_search_plants_passes_expected_request_signature() -> None:
    client = RecordingAsyncRequestClient()
    result = await client.search_plants(q="foo", field="address", distance_km=2.0)
    assert result["success"] is True
    assert client.calls == [
        (
            "GET",
...
@pytest.mark.asyncio
async def test_link_plant_passes_expected_request_signature() -> None:
    client = RecordingAsyncRequestClient()
    result = await client.link_plant(plant_uuid="plant-1", remark="memo", link_id="link-1")
    assert result["success"] is True
    assert client.calls == [
        (
            "POST",
...
@pytest.mark.asyncio
async def test_get_plant_info_passes_expected_request_signature() -> None:
    client = RecordingAsyncRequestClient()
    result = await client.get_plant_info("abc/def")
    assert result["success"] is True
    assert client.calls == [("GET", "/v1/links/abc%2Fdef", None, None)]


@pytest.mark.asyncio
async def test_get_plant_contract_normalizes_legacy_rec_fixed_contract_object() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
    ...
    client, http_client = make_async_client(handler)
    try:
        response = await client.get_plant_contract("link-1")
...
@pytest.mark.asyncio
async def test_get_plant_contract_defaults_ess_for_rec_contracts_items() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
        assert request.url.path == "/v1/links/link-1/contract"
        return httpx.Response(
            200,
...
async def test_link_detail_methods_pass_expected_request_signature(
    method_name: str, expected_path: str
) -> None:
    client = RecordingAsyncRequestClient()
    method = getattr(client, method_name)
    result = await method("abc/def")
    assert result["success"] is True
    assert client.calls == [("GET", expected_path, None, None)]


@pytest.mark.asyncio
async def test_get_monthly_generation_passes_expected_request_signature() -> None:
    client = RecordingAsyncRequestClient()
    result = await client.get_monthly_generation("a/b", start_year=2020, end_year=2021)
    assert result["success"] is True
    assert client.calls == [
        (
            "GET",
...
@pytest.mark.asyncio
async def test_get_monthly_billing_passes_expected_request_signature() -> None:
    client = RecordingAsyncRequestClient()
    result = await client.get_monthly_billing("a/b", start_year=2020, end_year=2021)
    assert result["success"] is True
    assert client.calls == [
        (
            "GET",
...
async def test_context_manager_closes_owned_http_client() -> None:
    async with AsyncOsolarLinkClient(api_key="test-key") as client:
...
async def test_close_does_not_close_injected_http_client() -> None:
    ...
    shared_http_client = httpx.AsyncClient(transport=transport)
    client = AsyncOsolarLinkClient(
        api_key="test-key",
        base_url="https://example.com",
